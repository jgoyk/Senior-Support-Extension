...
function Popup() {
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "w-full p-4" },
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("h1", { className: "text-3xl mt-4" }, "Assistance Settings"),
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", null, "Magnifying Glass"),
